...
local make = R("custom.snips").make

local load_override = R("core.utils").load_override

local present1, ls = pcall(require, "luasnip")
local present2, types = pcall(require, "luasnip.util.types")
...
vim.keymap.set("n", "<leader><leader>s", "<cmd>source ~/.config/nvim/lua/plugins/configs/luasnip.lua<CR>")
